...
plt.plot(1e-6*freq, PSD1, color='blue', label='phase noise')
plt.plot(1e-6*freq, PSD2, color='red', label='amp noise')
plt.plot(1e-6*freq, PSD3, color='k', label='shot noise')
plt.plot(1e-6*freq, PSD4, color='olive', label='elect noise')
plt.xlim(0, 1.2)
