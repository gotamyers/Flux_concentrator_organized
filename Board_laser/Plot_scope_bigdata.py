...
pickle_in = open("dB_avg_FFT_scope_theo_0(2).pickle", "rb")
...
for i in range(7):
    pickle_in = open("dB_avg_FFT_scope_theo_" + str(i + 1) + "(2).pickle", "rb")
    ...
    # ################################################################################################################
    # '''SAVE DICTIONARY'''
    # pickle_out = open("smoothed_data" + str(i + 1) + "(2).pickle", "wb")
